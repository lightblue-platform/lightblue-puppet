...
describe 'lightblue::eap::module::cors::metadata' do
  context 'when config is defined' do
    ...
    it do
      should contain_lightblue__service__cors__configure("#{directory}/lightblue-metadata-cors.json") \
      .with(config) \
  ...
  context 'when config is undefined' do
    ...
    it do
      should_not contain_lightblue__service__cors__configure("#{directory}/lightblue-metadata-cors.json")
    end
  end
end
